...
data = dict(
    ...
    train=dict(
        type='Underwater',
        ann_file='../data/train/annotations/trainall-revised.json',
    ...
    test=dict(
        type='Underwater',
#         ann_file='../data/train/annotations/trainall-revised-v2.json',
#         img_prefix='../data/train/image/',
...
optimizer = dict(type='Adam', lr=7e-05)
...
log_level = 'INFO'
work_dir = './revised_dirs/cascade_rcnn_r50_rfp_sac_iou_alldata_e15'
