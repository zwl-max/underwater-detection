...
data = dict(
    ...
    val=dict(
        type='Underwater',
        ann_file='../data/train/annotations/val.json',
        img_prefix='../data/train/val-image/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_x101_64x4d_fpn_dcn_e15'
load_from = './htc_dconv_c3-c5_mstrain_400_1400_x101_64x4d_fpn_20e_20190408-0e50669c.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 1)
